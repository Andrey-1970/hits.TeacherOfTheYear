        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EditBlocks_Tracks_TrackId",
                        column: x => x.TrackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MarkBlocks_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CellVals_ApplicationId",
                table: "CellVals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EditBlocks_TrackId",
                table: "EditBlocks",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_Fields_EditBlockId",
                table: "Fields",
                column: "EditBlockId");

            migrationBuilder.CreateIndex(
                name: "IX_Fields_MarkBlockId",
                table: "Fields",
                column: "MarkBlockId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldVals_ApplicationId",
                table: "FieldVals",
                column: "ApplicationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MarkBlocks_TrackId",
                table: "MarkBlocks",
                column: "TrackId");

            migrationBuilder.CreateIndex(
                name: "IX_Marks_MarkBlockId",
                table: "Marks",
                column: "MarkBlockId");

            migrationBuilder.CreateIndex(
                name: "IX_MarkVals_ApplicationId",
                table: "MarkVals",
                column: "ApplicationId");
